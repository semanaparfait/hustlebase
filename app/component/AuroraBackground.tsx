  ...
  return (
    <div className="relative min-h-screen w-full bg-slate-100 selection:bg-blue-200 overflow-x-hidden">
      ...
      <div className="fixed inset-0 w-full h-full z-0 pointer-events-none overflow-hidden">
        ...
        {/* Blob 4 */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-blob animation-delay-2000"></div>
