...
export default function Hero() {
  return (
    <main className="w-full h-screen  flex items-center p-10">
        

    <section className=" md:w-[35%] text-left flex flex-col gap-2 px-7">   
        <h1 className="text-6xl font-bold mb-4">Your career. <br /> Unlocked.</h1>
        ...
        <button className="bg-blue-600 text-white py-1 px-4 rounded-lg font-semibold cursor-pointer">Get Started</button>
